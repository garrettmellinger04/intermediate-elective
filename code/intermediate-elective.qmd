...
p <- ggplot(grass_plot) +
  ...
  # enlarge the circular chart by tightening the radial scale
  scale_y_continuous(
    limits = c(-max_count * 0.14, max_count * 0.95),
    expand = c(0, 0)
  ) +
  # convert the bar chart into a circular layout
  coord_polar(start = 0, clip = "off") +
  # add title and subtitle above the plot
  labs(
    title = "Observations of Grass Species in the NCOS Mesa Grassland",
    subtitle = "Bar height shows number of observations per grass species in 2025"
  ) +
 ...
 theme(
  ...
  # keep the polar chart circular and allow it to use more panel space
  aspect.ratio = 1,
  
  # center title and subtitle across the full plot area
  ...
  plot.subtitle = element_text(
    ...
    # shrink outer blank space
    plot.margin = margin(0.2, 0.2, 0.2, 0.2),
    
   # keep legend on right but make it more compact so the circle can grow
